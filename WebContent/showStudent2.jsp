...
<body>
	<h3>
		<i class="fa fa-angle-right"></i> 2015 Batch
	</h3>
	<div class="row mt">
		<div class="col-lg-12">
			<div class="content-panel">
				<h4>
					<i class="fa fa-angle-right"></i>CSE Students
				</h4>
				<section id="unseen">
				<center>
	...
	String tablename="student2015";
	//session.setAttribute("DropTableName",tablename);
	try {
